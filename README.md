...
Open VSCode and from the PlatformIO extension open the **PCB-Tree-ESP32** folder from the project you just cloned.

Build and upload the project to your ESP32 and attach the various wires to the PCB and you have buttons/buttons on the box.

#### NOTE: VSCode and PlatformIO required.
...
I created this support base so that the ESP32 with the cables and buttons can fit inside, but if it doesn't work for your ESP32 and you use another microcontroller I'll leave you the Fusion360 file to modify it as you like.
